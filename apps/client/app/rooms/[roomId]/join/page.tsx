...
export default function RoomJoinPage() {
  ...
  return (
    <div className="bg-background text-foreground relative flex min-h-screen flex-col items-center justify-center overflow-hidden p-4 font-sans md:p-8">
      <NoiseBackground />
          ...
          <div className="flex flex-col justify-between md:col-span-5">
            ...
            <div className="border-border mt-6 space-y-4 border-t pt-6">
              ...
              <div className="text-muted-foreground flex items-start gap-2 font-mono text-[9px] leading-relaxed uppercase">
                ...
                <span>
                  By joining, you authorize Ototabi to buffer your high-quality tracks inside a
                  secure local IndexedDB container for uploading.
                </span>
              </div>
            </div>
          </div>
