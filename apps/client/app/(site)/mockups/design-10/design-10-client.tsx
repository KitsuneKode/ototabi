...
export default function Design10ClientPage() {
  return (
      ...
      <main className="mx-auto mt-10 flex w-full max-w-4xl flex-1 flex-col items-center p-8">
        <div className="stagger-enter flex w-full flex-col gap-10">
          ...
          <div className="mt-6 flex justify-center">
            <button
              type="button"
              className="btn-press bg-[#111] px-10 py-4 text-sm tracking-wide text-white hover:bg-gray-800 focus:ring-2 focus:ring-black focus:ring-offset-2 focus:outline-none"
            >
              ENTER STUDIO
            </button>
          </div>
