    ...
    <div className="flex min-h-screen items-center justify-center bg-[#000000] p-4 font-sans text-[#ffffff]">
      ...
      <div className="sleek-panel fade-enter relative z-10 flex w-full max-w-2xl flex-col items-center p-8 shadow-2xl">
        ...
        <div className="fade-enter mb-8 flex w-full flex-col gap-3 delay-1">
          <button className="sleek-panel sleek-btn flex w-full items-center justify-between p-4 hover:bg-white/5">
        ...
        <div className="fade-enter flex w-full gap-4 delay-1">
          <button className="sleek-btn flex-1 rounded-xl bg-white/10 py-3.5 text-sm font-semibold hover:bg-white/15">
            Cancel
          </button>
          <button className="sleek-btn-primary sleek-btn flex-1 rounded-xl py-3.5 text-sm font-semibold">
            Join
          </button>
        </div>
      </div>
